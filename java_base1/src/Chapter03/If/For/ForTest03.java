...
public class ForTest03 {
	...
	public static void main(String[] args) {
		...
		/*//방법 1
		System.out.println("1부터 100까지의 합을 구하되 합이 100이하");
		...
		*/
		/*
		//방법2
		System.out.println("1부터 100까지의 합을 구하되 합이 100 미만 수중 가장 큰 수");
		int j;
		int sum1 = 0 ;
		for(j=1; j<=100;j++) {
			sum1 +=j;
		...
		*/
		//방법3
		System.out.println("1부터 100까지의 합을 구하되 합이 100 초과하는 첫번째 수 합");
		int k;
		int sum2 =0;
		for(k=1; sum2<100; k++) {
			sum2 +=k;
